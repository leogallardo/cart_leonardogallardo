      ...
      <header className="relative max-w-7xl mx-auto bg-indigo-900 py-6 lg:bg-transparent lg:grid lg:grid-cols-2 lg:gap-x-16 lg:px-8 lg:pt-16 lg:pb-10">
        <div className="max-w-2xl mx-auto flex px-4 lg:max-w-lg lg:w-full lg:px-0">
          <a href="#">
            ...
            <img src="https://tailwindui.com/img/logos/workflow-mark.svg?color=indigo&shade=300" alt="" className="h-8 w-auto lg:hidden" />
            <img src="https://tailwindui.com/img/logos/workflow-mark.svg?color=indigo&shade=600" alt="" className="hidden lg:block h-8 w-auto" />
          </a>
        </div>
      </header>
            ...
            <ul role="list" className="text-sm font-medium divide-y divide-white divide-opacity-10">
              {products.map((product) => (
                <li key={product.id} className="flex items-start py-6 space-x-4">
                  <img src={product.imageSrc} alt={product.imageAlt} className="flex-none w-20 h-20 rounded-md object-center object-cover" />
