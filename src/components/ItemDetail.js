...
const ItemDetail = ({ itemData }) => {
  return (
    <div className="max-w-2xl mx-auto pt-24 pb-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8 w-full">
      <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl mb-4">{itemData.name}</h1>
      ...
      <div className="lg:grid lg:grid-cols-2 lg:gap-x-8">
        <div>
          ...
          {itemData.stock === 0 ? (
            <div className="mt-6 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 w-5 h-5 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                {' '}
        ...
        <div className="mt-10 lg:mt-0 lg:col-start-2 lg:row-span-2 lg:self-center border rounded bg-white border-gray-200 p-4">
        ...
        <div className="mt-6">
          <ItemCount itemData={itemData} hasTrashCan={true} hasCartLink={true} />
        </div>
      </div>
    </div>
  );
